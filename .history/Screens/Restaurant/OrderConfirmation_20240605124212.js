...
const styles = StyleSheet.create({
  ...
  modalView: { width: 300, backgroundColor: 'white', borderRadius: 20, padding: 3, alignItems: 'center', shadowColor: '#000', shadowOffset: { width: 0, height: 2 }, shadowOpacity: 0.25, shadowRadius: 4, elevation: 5 },
  emojiImage: { width: 200, height: 200,bottom:120 },
  modalText: { fontSize: 25, fontWeight: 'bold' },
