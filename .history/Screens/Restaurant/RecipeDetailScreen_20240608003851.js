      ...
      <ScrollView>
        ...
        <View style={styles.container}>
          ...
          <View style={styles.infoRow}>
            ...
            <Text style={styles.infoLabel}>Minimum Time:</Text>
            <Text style={styles.infoValue}>{recipe.minTime || 'N/A'}</Text>
          </View>
          <View style={styles.infoRow}>
            <Ionicons name="time-outline" size={SPACING * 1.6} color={colors.gray} />
          ...
          <View style={styles.infoRow}>
            <Ionicons name="pricetag-outline" size={SPACING * 1.6} color={colors.gray} />
            <Text style={styles.infoLabel}>Promo Price:</Text>
            <Text style={styles.infoValue}>{recipe.promoPrice || 'N/A'}</Text>
          </View>
          <View style={styles.infoRow}>
