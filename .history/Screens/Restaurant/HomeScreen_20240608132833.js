...
const HomeScreen = () => {
  ...
  useEffect(() => {
    ...
    const fetchCategories = async () => {
      try {
        const response = await axios.get('          const response = await axios.get(`http://192.168.113.110:7777/user-service/api/v1/user/${userId}`);
:7777/category-service/api/category');
