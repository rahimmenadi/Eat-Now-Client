...
import { useGetAllProductsQuery } from "../../redux/APIs/authApi";
...
>
            ...
            {data?.results.map((item) => (
              <TouchableOpacity
  style={{ width: ITEM_WIDTH, marginBottom: SPACING * 2 }}
 onPress={() => navigation.navigate('RecipeDetailScreen', { recipeId: item.id, posterPath: item.poster_path, data: data })}
