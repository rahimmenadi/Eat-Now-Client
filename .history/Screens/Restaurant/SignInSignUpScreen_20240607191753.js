...
import { getLocalIpAddress } from './networkUtils'; // Adjust the path as necessary
...
const SignInScreen = () => {
  ...
  const handleSignIn = async () => {
    try {
      ...
      const response = await axios.post('http://${localIpAddress}:7777/user-service/api/v1/login/client', {
        email,
        password,
      });
      ...
      console.log(await getLocalIpAddress())
