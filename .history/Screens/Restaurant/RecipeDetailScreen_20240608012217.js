...
const RecipeDetailScreen = ({ route }) => {
  ...
  const [addedToWishlist, setAddedToWishlist] = useState(false);  const [addedToWishlist, setAddedToWishlist] = useState(false);
    ...
    <>
      ...
      >
        <Ionicons
          name="heart"
          size={SPACING * 2.5}
          color={addedToWishlist ? colors.red : colors.gray} // Change color to red if added to wishlist
        />
      </TouchableOpacity>
          </ImageBackground>
          <View
