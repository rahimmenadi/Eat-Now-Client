...
import LocationComponent from "./Screens/Restaurant/LocationComponent";
    ...
    <Provider store={store}>
      <NavigationContainer>
        <Stack.Navigator>
          ...
          {isLoading ? null : ( // Render LocationComponent if not loading
            <Stack.Screen name="LocationComponent" component={LocationComponent} options={{ headerShown: false }} />
          )}
          {!isLoading && ( // Render other screens only if not loading
            <>
