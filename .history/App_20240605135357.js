...
import NotificationScreen from "./Screens/Restaurant/NotificationScreen"; // Import NotificationScreen
      ...
      <Stack.Navigator>
        {isLoading ? (
          ...
          <>
            ...
            <Stack.Screen name="NotificationScreen" component={NotificationScreen} options={{ headerShown: false }} /> {/* Add NotificationScreen */}
          </>
        )}
      </Stack.Navigator>
    </NavigationContainer>
