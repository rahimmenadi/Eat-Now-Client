...
import OrderDetailsScreen from "./Screens/Restaurant/OrderDetailsScreen"; // Import OrderDetailsScreen
      ...
      <Stack.Navigator>
        {isLoading ? (
          ...
          <>
            ...
            <Stack.Screen name="OrderDetailsScreen" component={OrderDetailsScreen} options={{ headerShown: false }} /> {/* Add OrderDetailsScreen */}
          </>
        )}
      </Stack.Navigator>
    </NavigationContainer>
